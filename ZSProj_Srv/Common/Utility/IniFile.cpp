...
int CIniFile::ReadString(
	 ...
	 const char* lpFileName)
{
	return read_profile_string(lpAppName, lpKeyName, 
		lpReturnedString, nSize, lpDefault, lpFileName);
}
...
int CIniFile::ReadInt(
	...
	const char* lpFileName)
{
	return read_profile_int(lpAppName, lpKeyName, nDefault, lpFileName);
}
...
int CIniFile::WriteString(
	...
	const char* lpFileName)
{
	return write_profile_string(lpAppName, lpKeyName, lpString, lpFileName);
}
