#ifndef SYSBASE_SERVICE_CNTSERVICE_H
#define SYSBASE_SERVICE_CNTSERVICE_H
...
public:		// construction/destruction
    ...
    CNTService(LPCTSTR lpServiceName, LPCTSTR lpDisplayName = NULL, LPCTSTR lpDesc = NULL);
    virtual ~CNTService();
